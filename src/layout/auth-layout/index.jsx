                    ...
                    <div className="w-[431px]">
                        <div className="p-6 space-y-4 ">
                            ...
                            <form onSubmit={(e) => {
                                ...
                                <button type="submit" className="w-[400px] h-[64px] text-white bg-indigo-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Connection</button>
